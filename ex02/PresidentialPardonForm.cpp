...
PresidentialPardonForm::PresidentialPardonForm( void ) : Form("default_shrub", 25, 5), _target("target") {
...
PresidentialPardonForm::PresidentialPardonForm( std::string target ) : Form("default_shrub", 25, 5), _target(target) {
...
PresidentialPardonForm::PresidentialPardonForm( PresidentialPardonForm const & src ) : Form("default_shrub", 25, 5), _target(src.getTarget()) {
...
void    PresidentialPardonForm::forgiveTarget( void ) {
